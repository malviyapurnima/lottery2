...
function DeletePoolModal({ isOpen, onClose, onConfirm }) {
    return (
        isOpen && (
            <div className="fixed inset-0 flex items-center justify-center bg-primary-dark bg-opacity-50">
                <div className="bg-white p-8 rounded shadow-lg text-center">
                    ...
                    <div className='flex gap-5 justify-center'>
                        <button type="button" onClick={onConfirm} className="text-white bg-primary-light hover:bg-primary-dark font-medium rounded-lg text-sm px-5 py-2.5 text-center">Delete Pool</button>
